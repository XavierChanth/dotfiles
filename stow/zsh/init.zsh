...
# Pagers
export LESS='--mouse'
export MANPAGER="nvim -c 'set ft=man | AnsiHighlight' -"
...
# prompt
if [ -f "$XDG_CONFIG_HOME/spaceship-prompt/spaceship.zsh" ]; then
